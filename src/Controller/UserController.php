...
#[Route('/user')]
#[IsGranted(attribute: UserVoter::LIST)]
class UserController extends AbstractController
{
    ...
    #[IsGranted(attribute: UserVoter::CREATE)]
    ...
    #[IsGranted(attribute: UserVoter::MANAGE, subject: 'user')]
    ...
    #[IsGranted(attribute: UserVoter::DELETE, subject: 'user')]
